...
export function WhyUs({ site }: { site: SiteContent }) {
  ...
  return (
    <>
      <p className="absolute left-[1253px] top-[5200px] w-[345px] -translate-x-full text-right text-[36px] font-medium leading-[18px] text-[#196cb5]">
        {whyUs.title}
      </p>
      <p className="absolute left-[1253px] top-[5256px] w-[1039px] -translate-x-full text-right text-[36px] font-medium leading-[18px] text-[#196cb5]">
        {whyUs.subtitle}
      </p>
